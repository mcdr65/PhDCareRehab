...
The data.frame `d.long2` consists of time points 1 and 2. The true
values are
...
## Simulation
Let us again simulate some data with an R-function. You need not to understand the code for simulation.
