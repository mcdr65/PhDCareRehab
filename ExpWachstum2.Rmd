...
cases<-c(100,114,214,268,337,374,491,652,652,1100,1359,
         2200,2200,2650,3000,4100,5300,6600,7500,8800,9900,
         10900,11800,12900,14100,14800,15900,16600,17800,18800,19600,20500,21100)
tag<-1:length(cases)
##################################################
T1<-1
T2<-2
...
plot(time,Y1,type="l",ylab="cases",ylim=c(100,30000),xlab="days",las=1)
